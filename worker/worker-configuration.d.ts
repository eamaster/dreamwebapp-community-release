/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 92c3b799b3eba3354b65a33e1c0d3615)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
	CONTENT_KV: KVNamespace;
	LOGO_ASSETS: R2Bucket;
	DB: D1Database;
	AI: Ai;
	CORS_ORIGIN: string;
	ENVIRONMENT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGIN" | "ENVIRONMENT">> {}
}
